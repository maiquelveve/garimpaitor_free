...
import { CREATE_MARKETPLACE } from '../../../../../graphql/marketplace/mutation';
...
export default function CreateMarketplace() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const result = await createMarketplace({ variables });
  ...
  ] = useMutation(CREATE_MARKETPLACE, optionsCreateMarketplacesSystem);
  ...
  const loadings = {
    ...
    loadingGetStates,
    loadingGetCitys,
    loadingActionMarketplace: loadingCreateMarketplace,
  }
